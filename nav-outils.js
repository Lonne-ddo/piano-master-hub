...
(function () {
    ...
    // 4 items : Quiz + Grilles + Métronome + Accords (Bibli retirée — cf
    // commit 'masque Bibli élève'). Le fichier bibli.html reste accessible
    // via URL directe pour l'admin en impersonation.
    var ITEMS = [
    ...
    var css = [
        '.bottom-nav{position:fixed;bottom:0;left:0;right:0;display:grid;grid-template-columns:repeat(4,1fr);padding:6px 0 calc(6px + env(safe-area-inset-bottom));background:rgba(15,15,20,0.92);backdrop-filter:blur(24px) saturate(180%);-webkit-backdrop-filter:blur(24px) saturate(180%);border-top:1px solid rgba(255,255,255,0.06);z-index:100;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;}',
